...
st.write(df.columns)
df = df.rename(columns={'539737':'InvoiceNo', '21949':'StockCode','SET OF 6 STRAWBERRY CHOPSTICKS':'Description','1':'Quantity','12/21/2010 15:19':'InvoiceDate','2.51':'UnitPrice','United Kingdom':'Country'},inplace=True)
st.write(df.columns)
